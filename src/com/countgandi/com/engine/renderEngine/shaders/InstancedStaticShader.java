...
public class InstancedStaticShader extends ShaderProgram {
	private static final int MaxLights = 4;
	public static final int MAX_INSTANCED = 1000;

	private static final String VERTEX_FILE = "src/com/countgandi/com/engine/renderEngine/shaders/vertexShaderInstanced.txt";
